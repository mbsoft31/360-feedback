...
>
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        -->
        <div x-show="show"
             class="inline-block bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:my-8 {{ $maxWidth }} sm:w-full"
             x-transition:enter="ease-out duration-300"
            ...
            <div class="bg-white text-start">
                <x-card.title class="p-0">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        {{ __('Create a new survey') }}
                    </h3>
                ...
                <x-card.body>
                    <x-survey.create-form class="text-start" />
                </x-card.body>
            </div>
            <div class="bg-gray-50  px-4 py-3 sm:flex sm:justify-end sm:px-6 space-x-3">

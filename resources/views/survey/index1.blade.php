                            ...
                            @forelse($surveys as $survey)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 space-x-2 whitespace-nowrap text-end text-sm font-medium">
                                        <button wire:click="$emit('editSurvey', {{ $survey }})" class="inline-block text-indigo-600 hover:text-indigo-900">{{__('Edit')}}</button>
                                        <button wire:click="$emit('deleteSurvey', {{ $survey }})" class="inline-block text-red-600 hover:text-red-900">{{__('Delete')}}</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
